...
const strings = {
  en: {
    ...
    hintMdns: 'Use the <strong>Local IP</strong> in the iOS Shortcut endpoint (same Wi-Fi network).',
  ...
  'pt-BR': {
    ...
    hintMdns: 'Use o <strong>IP local</strong> no endpoint do Atalho iOS (mesma rede Wi-Fi).',
